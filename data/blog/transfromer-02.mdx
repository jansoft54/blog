...
<figure style={{ width: '100%', margin: 'auto', paddingLeft: '0%', marginBottom: '3rem' }}>
  ...
  />
    ...
    <a href="https://ai.meta.com/blog/meta-llama-3/" target="_blank" rel="noopener noreferrer">
      Image source{' '}
    </a>
  </figcaption>
</figure>
...
<figcaption style={{ textAlign: 'center', fontSize: '0.9rem', color: '#666' }}>
<a href="https://arxiv.org/pdf/2305.13245" target="_blank" rel="noopener noreferrer">
Image source{' '}
</a>
...
<figure style={{ width: '100%', margin: 'auto', paddingLeft: '15%' }}>
  ...
  />
  <figcaption style={{ textAlign: 'center', fontSize: '0.9rem', color: '#666' }}>
<a href="https://medium.com/@vi.ai_/exploring-and-building-the-llama-3-architecture-a-deep-dive-into-components-coding-and-43d4097cfbbb" target="_blank" rel="noopener noreferrer">
Image source{' '}
</a>
